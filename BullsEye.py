...
# )
with st.sidebar:
    selected = option_menu("Main Menu", ["Home", "Visualization", "Prediction", "Accuracy"], 
        icons=['house', 'gear', 'book', 'envelope'], menu_icon="cast", default_index=1)
...
if selected == "Home":
    ...
    st.write("Welcome to our Stock Predictor website, where we use Machine learning techniques to help you make informed decisions about your investments. Our team of experts has developed a Linear Regression model that predicts the closing price of a stock based on historical data and market trends.")
    st.write("\n")
